...
public class MathsChallengeLeaderboard extends JFrame {
    private JTable leaderboardTable;
    private DefaultTableModel tableModel;

    // Constructor to set up the leaderboard window
    public MathsChallengeLeaderboard() throws RemoteException {
        super("Maths Leaderboard");
        ...
        // Create a panel to hold the components with the background image
        ...
        JLabel titleLabel = new JLabel("<html><body style='text-align:center; font-size:36px; color:white; font-weight:bold;'>Maths Challenge Leaderboard</body></html>");
...
//                mathsChallengeHome.setVisible(true);
            } catch (Exception ex) {
                ex.printStackTrace();
            }
        });
...
//        buttonPanel.setOpaque(false); // Make the button panel transparent
        ...
        // Add the button panel above the main content
    ...
    private void loadLeaderboardData() throws RemoteException {
        ...
        List<Score> scoreList = scoreBoardInterface.getScoreList("Maths Game");
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(() -> {
            MathsChallengeLeaderboard mathsChallengeLeaderboard = null;
            try {
                mathsChallengeLeaderboard = new MathsChallengeLeaderboard();
            } catch (RemoteException e) {
                throw new RuntimeException(e);
            }
            mathsChallengeLeaderboard.setVisible(true);
        });
    }
    ...
    private class BackgroundPanel extends JPanel {
        ...
        public BackgroundPanel() {
            try {
                ...
                backgroundImage = new ImageIcon(getClass().getResource("../img/background/mathsleaderborad.jpg")).getImage();
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
